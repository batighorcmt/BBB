...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Create Item</h2>
        </template>
                        ...
                        <form @submit.prevent="submit" enctype="multipart/form-data">
                            ...
                            <div class="mb-8">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Item Code (Auto-generated)</label>
                                        <input type="text" class="mt-1 block w-full rounded-md border-gray-300 bg-gray-100 dark:bg-gray-600 text-gray-500 cursor-not-allowed" placeholder="ITM-XXXX" disabled>
                                    </div>
                                    ...
                                    <div v-if="form.type === 'product'">
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Opening Stock</label>
                            ...
                            <div v-if="form.type === 'product'">
                                ...
                                <div class="mb-8">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        ...
                                        <div class="col-span-1 md:col-span-2">
                                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Design File (Upload)</label>
